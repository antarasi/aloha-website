        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="aspect-video bg-background rounded-lg shadow-medium overflow-hidden">
              <div className="flex h-full">
                ...
                <div className="w-1/3 bg-muted/50 p-4 space-y-3">
                  ...
                  {[
                    { icon: Search, text: "Best coffee shops in SF", messages: "6 messages" },
                    { icon: Globe, text: "Browser compatibility", messages: "4 messages" },
                    { icon: Brain, text: "Explain quantum physics", messages: "8 messages" },
                    { icon: MessageSquare, text: "Tool capabilities", messages: "2 messages" },
                  ].map((chat, index) => (
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            {[
              ...
              <Card key={index} className="p-6 gradient-card border-0 shadow-medium text-center animate-fade-in" style={{ animationDelay: `${index * 0.1 + 0.5}s` }}>
